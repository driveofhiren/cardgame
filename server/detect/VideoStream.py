...
class VideoStream:
    """Camera object"""
    def __init__(self, resolution=(640,480),framerate=30,PiOrUSB=2,src="https://192.168.2.106:8080/video"):
        ...
        if self.PiOrUSB == 3: # IP camera (HTTP/RTSP stream)
            # Initialize the IP camera stream
            # src should be the full URL: "http://192.168.2.106:8080/" or "rtsp://..."
            self.stream = cv2.VideoCapture(src)
